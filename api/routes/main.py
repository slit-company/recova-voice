...
from api.routes.telephony_number_inventory import (
    customer_router as telephony_number_inventory_customer_router,
    operator_router as telephony_number_inventory_operator_router,
)
