...
| Recova 배정 번호 UX | Partial | `ui/src/app/telephony-numbers/page.tsx`, `context/own-telephony-handoff/01-current-state.md` | 코어 UI는 있으나 실공급자 번호와 live attestation 전 production-ready 아님 |
| 자체 한국 070 trunk | Waiting | `context/own-telephony-handoff/01-current-state.md` | 공급자 계약과 실제 통화 readiness evidence를 기다림 |
...
| 한국어 제품 UX | Partial | locale context와 번역 테이블, `plans/korean-locale-fallback-audit.md` | 영어 fallback 감사 계획은 아직 완료 표시되지 않음 |
