            ...
            <div className="container mx-auto px-4 py-8">
                <div className="max-w-6xl mx-auto">
                    <div className="mb-8">
                        ...
                        <p className="text-muted-foreground">Manage your API keys to access Recova services programmatically</p>
                    </div>
                    ...
                    {/* Recova Service Keys Section */}
                    <Card className="mb-6">
                        <CardHeader>
                            <div className="flex justify-between items-center">
                                <div>
                                    <CardTitle>Recova Service Keys</CardTitle>
                                    <CardDescription>
                                ...
                                <div className="flex gap-2">
                                    ...
                                    {canCreateServiceKey ? (
                                        ...
                                        <span className="text">
                                            To generate additional service keys, <a href="https://app.dograh.com" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">Sign up for Recova Cloud</a>
                                        </span>
                                    )}
                                </div>
                            </div>
