      ...
      <CardContent className="space-y-4">
              ...
              >
                <div className="flex-1">
                  ...
                  <Input
                    value={value}
                    onChange={(e) =>
                      handleUpdateContextVar(key, e.target.value)
                    }
                    disabled={disabled}
                    className="mt-1"
                  />
        ...
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            <div className="flex-1">
              <Input
                placeholder={t("runDetail.variableKey")}
                value={newKey}
            ...
            <div className="flex-1">
              <Input
                placeholder={t("runDetail.variableValue")}
                value={newValue}
            ...
            <Button
              ...
              disabled={
                !newKey || !newValue || disabled || !!initialContext[newKey]
              }
            >
              Add
            </Button>
