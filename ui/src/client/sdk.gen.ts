...
/**
 * Handle Clawops Status Callback
 *
 * Handle ClawOps status callbacks.
 */
export const handleClawopsStatusCallbackApiV1TelephonyClawopsStatusCallbackWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleClawopsStatusCallbackApiV1TelephonyClawopsStatusCallbackWorkflowRunIdPostData, ThrowOnError>) => (options.client ?? client).post<HandleClawopsStatusCallbackApiV1TelephonyClawopsStatusCallbackWorkflowRunIdPostResponses, HandleClawopsStatusCallbackApiV1TelephonyClawopsStatusCallbackWorkflowRunIdPostErrors, ThrowOnError>({ url: '/api/v1/telephony/clawops/status-callback/{workflow_run_id}', ...options });
...
/**
 * Handle Jambonz Status
 *
 * Handle Jambonz status and CDR callbacks.
 */
export const handleJambonzStatusApiV1TelephonyJambonzCdrWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleJambonzStatusApiV1TelephonyJambonzCdrWorkflowRunIdPostData, ThrowOnError>) => (options.client ?? client).post<HandleJambonzStatusApiV1TelephonyJambonzCdrWorkflowRunIdPostResponses, HandleJambonzStatusApiV1TelephonyJambonzCdrWorkflowRunIdPostErrors, ThrowOnError>({ url: '/api/v1/telephony/jambonz/cdr/{workflow_run_id}', ...options });
 ...
 * Handle Jambonz status and CDR callbacks.
 */
export const handleJambonzStatusApiV1TelephonyJambonzStatusWorkflowRunIdPost = <ThrowOnError extends boolean = false>(options: Options<HandleJambonzStatusApiV1TelephonyJambonzStatusWorkflowRunIdPostData, ThrowOnError>) => (options.client ?? client).post<HandleJambonzStatusApiV1TelephonyJambonzStatusWorkflowRunIdPostResponses, HandleJambonzStatusApiV1TelephonyJambonzStatusWorkflowRunIdPostErrors, ThrowOnError>({ url: '/api/v1/telephony/jambonz/status/{workflow_run_id}', ...options });
...
/**
 * Import Telephony Number Inventory
 */
export const importTelephonyNumberInventoryApiV1TelephonyNumberInventoryImportPost = <ThrowOnError extends boolean = false>(options: Options<ImportTelephonyNumberInventoryApiV1TelephonyNumberInventoryImportPostData, ThrowOnError>) => (options.client ?? client).post<ImportTelephonyNumberInventoryApiV1TelephonyNumberInventoryImportPostResponses, ImportTelephonyNumberInventoryApiV1TelephonyNumberInventoryImportPostErrors, ThrowOnError>({
...
/**
 * Import Onnuri Staging Candidates
 */
export const importOnnuriStagingCandidatesApiV1TelephonyNumberInventoryOnnuriStagingCandidatesImportPost = <ThrowOnError extends boolean = false>(options: Options<ImportOnnuriStagingCandidatesApiV1TelephonyNumberInventoryOnnuriStagingCandidatesImportPostData, ThrowOnError>) => (options.client ?? client).post<ImportOnnuriStagingCandidatesApiV1TelephonyNumberInventoryOnnuriStagingCandidatesImportPostResponses, ImportOnnuriStagingCandidatesApiV1TelephonyNumberInventoryOnnuriStagingCandidatesImportPostErrors, ThrowOnError>({
...
/**
 * Approve Onnuri Staging Preflight Proof
 */
export const approveOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsApprovePost = <ThrowOnError extends boolean = false>(options: Options<ApproveOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsApprovePostData, ThrowOnError>) => (options.client ?? client).post<ApproveOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsApprovePostResponses, ApproveOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsApprovePostErrors, ThrowOnError>({
...
/**
 * Reserve Onnuri Staging Inventory
 */
export const reserveOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdReservePost = <ThrowOnError extends boolean = false>(options: Options<ReserveOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdReservePostData, ThrowOnError>) => (options.client ?? client).post<ReserveOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdReservePostResponses, ReserveOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdReservePostErrors, ThrowOnError>({
...
/**
 * Assign Onnuri Staging Inventory
 */
export const assignOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdAssignPost = <ThrowOnError extends boolean = false>(options: Options<AssignOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdAssignPostData, ThrowOnError>) => (options.client ?? client).post<AssignOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdAssignPostResponses, AssignOnnuriStagingInventoryApiV1TelephonyNumberInventoryOnnuriStagingInventoryInventoryIdAssignPostErrors, ThrowOnError>({
...
/**
 * Retire Onnuri Staging Candidate
 */
export const retireOnnuriStagingCandidateApiV1TelephonyNumberInventoryOnnuriStagingCandidatesCandidateIdRetirePost = <ThrowOnError extends boolean = false>(options: Options<RetireOnnuriStagingCandidateApiV1TelephonyNumberInventoryOnnuriStagingCandidatesCandidateIdRetirePostData, ThrowOnError>) => (options.client ?? client).post<RetireOnnuriStagingCandidateApiV1TelephonyNumberInventoryOnnuriStagingCandidatesCandidateIdRetirePostResponses, RetireOnnuriStagingCandidateApiV1TelephonyNumberInventoryOnnuriStagingCandidatesCandidateIdRetirePostErrors, ThrowOnError>({
...
/**
 * Revoke Onnuri Staging Preflight Proof
 */
export const revokeOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsProofIdRevokePost = <ThrowOnError extends boolean = false>(options: Options<RevokeOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsProofIdRevokePostData, ThrowOnError>) => (options.client ?? client).post<RevokeOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsProofIdRevokePostResponses, RevokeOnnuriStagingPreflightProofApiV1TelephonyNumberInventoryOnnuriStagingProofsProofIdRevokePostErrors, ThrowOnError>({
...
/**
 * List Telephony Number Inventory
 */
export const listTelephonyNumberInventoryApiV1TelephonyNumberInventoryGet = <ThrowOnError extends boolean = false>(options?: Options<ListTelephonyNumberInventoryApiV1TelephonyNumberInventoryGetData, ThrowOnError>) => (options?.client ?? client).get<ListTelephonyNumberInventoryApiV1TelephonyNumberInventoryGetResponses, ListTelephonyNumberInventoryApiV1TelephonyNumberInventoryGetErrors, ThrowOnError>({ url: '/api/v1/telephony-number-inventory', ...options });

/**
 * Reserve Telephony Number Inventory
 */
export const reserveTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdReservePost = <ThrowOnError extends boolean = false>(options: Options<ReserveTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdReservePostData, ThrowOnError>) => (options.client ?? client).post<ReserveTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdReservePostResponses, ReserveTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdReservePostErrors, ThrowOnError>({
...
/**
 * Assign Telephony Number Inventory
 */
export const assignTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdAssignPost = <ThrowOnError extends boolean = false>(options: Options<AssignTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdAssignPostData, ThrowOnError>) => (options.client ?? client).post<AssignTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdAssignPostResponses, AssignTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdAssignPostErrors, ThrowOnError>({
...
/**
 * Quarantine Telephony Number Inventory
 */
export const quarantineTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdQuarantinePost = <ThrowOnError extends boolean = false>(options: Options<QuarantineTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdQuarantinePostData, ThrowOnError>) => (options.client ?? client).post<QuarantineTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdQuarantinePostResponses, QuarantineTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdQuarantinePostErrors, ThrowOnError>({
...
/**
 * Retire Telephony Number Inventory
 */
export const retireTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdRetirePost = <ThrowOnError extends boolean = false>(options: Options<RetireTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdRetirePostData, ThrowOnError>) => (options.client ?? client).post<RetireTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdRetirePostResponses, RetireTelephonyNumberInventoryApiV1TelephonyNumberInventoryInventoryIdRetirePostErrors, ThrowOnError>({
...
/**
 * Attest Telephony Number Inventory Live Validation
 */
export const attestTelephonyNumberInventoryLiveValidationApiV1TelephonyNumberInventoryInventoryIdLiveValidationPost = <ThrowOnError extends boolean = false>(options: Options<AttestTelephonyNumberInventoryLiveValidationApiV1TelephonyNumberInventoryInventoryIdLiveValidationPostData, ThrowOnError>) => (options.client ?? client).post<AttestTelephonyNumberInventoryLiveValidationApiV1TelephonyNumberInventoryInventoryIdLiveValidationPostResponses, AttestTelephonyNumberInventoryLiveValidationApiV1TelephonyNumberInventoryInventoryIdLiveValidationPostErrors, ThrowOnError>({
...
/**
 * List Telephony Number Inventory Audit
 */
export const listTelephonyNumberInventoryAuditApiV1TelephonyNumberInventoryInventoryIdAuditGet = <ThrowOnError extends boolean = false>(options: Options<ListTelephonyNumberInventoryAuditApiV1TelephonyNumberInventoryInventoryIdAuditGetData, ThrowOnError>) => (options.client ?? client).get<ListTelephonyNumberInventoryAuditApiV1TelephonyNumberInventoryInventoryIdAuditGetResponses, ListTelephonyNumberInventoryAuditApiV1TelephonyNumberInventoryInventoryIdAuditGetErrors, ThrowOnError>({ url: '/api/v1/telephony-number-inventory/{inventory_id}/audit', ...options });

/**
 * List Customer Assigned Telephony Numbers
 */
export const listCustomerAssignedTelephonyNumbersApiV1OrganizationsTelephonyNumbersAssignedGet = <ThrowOnError extends boolean = false>(options?: Options<ListCustomerAssignedTelephonyNumbersApiV1OrganizationsTelephonyNumbersAssignedGetData, ThrowOnError>) => (options?.client ?? client).get<ListCustomerAssignedTelephonyNumbersApiV1OrganizationsTelephonyNumbersAssignedGetResponses, ListCustomerAssignedTelephonyNumbersApiV1OrganizationsTelephonyNumbersAssignedGetErrors, ThrowOnError>({ url: '/api/v1/organizations/telephony-numbers/assigned', ...options });

/**
 * Unbind Customer Assigned Telephony Number
 */
export const unbindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindDelete = <ThrowOnError extends boolean = false>(options: Options<UnbindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindDeleteData, ThrowOnError>) => (options.client ?? client).delete<UnbindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindDeleteResponses, UnbindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindDeleteErrors, ThrowOnError>({ url: '/api/v1/organizations/telephony-numbers/assigned/{inventory_id}/bind', ...options });

/**
 * Bind Customer Assigned Telephony Number
 */
export const bindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindPost = <ThrowOnError extends boolean = false>(options: Options<BindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindPostData, ThrowOnError>) => (options.client ?? client).post<BindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindPostResponses, BindCustomerAssignedTelephonyNumberApiV1OrganizationsTelephonyNumbersAssignedInventoryIdBindPostErrors, ThrowOnError>({
 ...
 * Start Phone Preview
 */
export const startPhonePreviewApiV1PhonePreviewStartPost = <ThrowOnError extends boolean = false>(options: Options<StartPhonePreviewApiV1PhonePreviewStartPostData, ThrowOnError>) => (options.client ?? client).post<StartPhonePreviewApiV1PhonePreviewStartPostResponses, StartPhonePreviewApiV1PhonePreviewStartPostErrors, ThrowOnError>({
...
/**
 * Verify Phone Preview
 */
export const verifyPhonePreviewApiV1PhonePreviewVerifyPost = <ThrowOnError extends boolean = false>(options: Options<VerifyPhonePreviewApiV1PhonePreviewVerifyPostData, ThrowOnError>) => (options.client ?? client).post<VerifyPhonePreviewApiV1PhonePreviewVerifyPostResponses, VerifyPhonePreviewApiV1PhonePreviewVerifyPostErrors, ThrowOnError>({
 ...
 * Call Phone Preview
 */
export const callPhonePreviewApiV1PhonePreviewCallPost = <ThrowOnError extends boolean = false>(options: Options<CallPhonePreviewApiV1PhonePreviewCallPostData, ThrowOnError>) => (options.client ?? client).post<CallPhonePreviewApiV1PhonePreviewCallPostResponses, CallPhonePreviewApiV1PhonePreviewCallPostErrors, ThrowOnError>({
...
/**
 * Contain Phone Preview
 */
export const containPhonePreviewApiV1PhonePreviewContainPost = <ThrowOnError extends boolean = false>(options: Options<ContainPhonePreviewApiV1PhonePreviewContainPostData, ThrowOnError>) => (options.client ?? client).post<ContainPhonePreviewApiV1PhonePreviewContainPostResponses, ContainPhonePreviewApiV1PhonePreviewContainPostErrors, ThrowOnError>({
...
/**
 * Wait For Inbound Phone Preview
 */
export const waitForInboundPhonePreviewApiV1PhonePreviewWaitInboundPost = <ThrowOnError extends boolean = false>(options: Options<WaitForInboundPhonePreviewApiV1PhonePreviewWaitInboundPostData, ThrowOnError>) => (options.client ?? client).post<WaitForInboundPhonePreviewApiV1PhonePreviewWaitInboundPostResponses, WaitForInboundPhonePreviewApiV1PhonePreviewWaitInboundPostErrors, ThrowOnError>({
...
/**
 * Get Phone Preview Status By Status Path
 */
export const getPhonePreviewStatusByStatusPathApiV1PhonePreviewStatusSessionIdGet = <ThrowOnError extends boolean = false>(options: Options<GetPhonePreviewStatusByStatusPathApiV1PhonePreviewStatusSessionIdGetData, ThrowOnError>) => (options.client ?? client).get<GetPhonePreviewStatusByStatusPathApiV1PhonePreviewStatusSessionIdGetResponses, GetPhonePreviewStatusByStatusPathApiV1PhonePreviewStatusSessionIdGetErrors, ThrowOnError>({ url: '/api/v1/phone-preview/status/{session_id}', ...options });

/**
 * Get Phone Preview Status
 */
export const getPhonePreviewStatusApiV1PhonePreviewSessionIdGet = <ThrowOnError extends boolean = false>(options: Options<GetPhonePreviewStatusApiV1PhonePreviewSessionIdGetData, ThrowOnError>) => (options.client ?? client).get<GetPhonePreviewStatusApiV1PhonePreviewSessionIdGetResponses, GetPhonePreviewStatusApiV1PhonePreviewSessionIdGetErrors, ThrowOnError>({ url: '/api/v1/phone-preview/{session_id}', ...options });
